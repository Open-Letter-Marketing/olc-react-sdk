...
export const addSafetyBordersToTriFold = (store: Store): void => {
    ...
    const firstPageBorders: Element = {
        ...
        showInExport: false,
        children: [
            createBorder(`top-1-${randomizedId}`, 25, 24, 815, 2.94, 0),
            createBorder(`bottom-1-${randomizedId}`, 25, 1125, 815, 2.94, 0),
            createBorder(`left-1-${randomizedId}`, 24, 1125, 1100, 2.94, -90),
            createBorder(`right-1-${randomizedId}`, 837, 1125, 1100, 2.94, -90),
        ],
    };
